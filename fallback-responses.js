...
const FALLBACK_RESPONSES = {
  // 深度约会分析回退响应
  deep_analysis: {
    展示财富: `从你的描述来看，这位男士在约会中展示收入和生活品质，可能是为了建立吸引力。但如果伴随着对你的要求和限制，这可能反映了几个问题：

**行为分析：**
• 高价值展示（DHV）：通过展示资源来建立吸引力
• 框架设定：试图定义关系中的权力动态
• 测试行为：通过设定标准来观察你的反应

**建议应对：**
1. **保持独立判断** - 不要因为对方的财富而忽视其他重要品质
2. **明确个人边界** - 对于过分的要求，温和但坚定地表达自己的立场
3. **观察一致性** - 看他的行为是否与言语一致
4. **重视相互尊重** - 健康的关系应该是双向的尊重和理解

记住，真正的高价值男性会欣赏你的独立性，而不是试图控制你。`,
